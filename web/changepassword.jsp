<%-- 
    Document   : verifyotp
    Created on : 18 Feb, 2019, 4:01:42 AM
    Author     : ASUS
--%>
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <form class="form-horizontal form-signin" method="post" >                            
                                                <fieldset class="form-label-group">
                                                    <input type="password" class="form-control" name="txtpassword" id="password" placeholder="Your New Password" value="" required="" autofocus="">
                                                    <label for="New Password">New Password</label>
                                                </fieldset>
                                                 <fieldset class="form-label-group">
                                                    <input type="password" class="form-control" name="txtCpassword" id="confirm_password" placeholder="Confirm Password" value="" required="" autofocus="">
                                                    <label for="Confirm Password">Confirm Password</label>
                                                </fieldset>
                                                <button type="submit" class="btn-gradient-primary btn-block my-1" name="change ">Change Now</button>
