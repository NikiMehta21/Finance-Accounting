<%-- 
    Document   : monthly
    Created on : 10 Mar, 2019, 9:26:45 AM
    Author     : ASUS
--%>
...
<!--===============================================================================================-->
    	...
    	<div class="limiter">
            <div class="knockout">Monthly Registered</div>
			...
			<div class="wrap-table100">
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/growfunds_db", "root", "");
                 Statement st = con.createStatement();
                   ...
                   ld="2019-03-10";
                   fd="2019-02-01";
                         sql="select * from user_master where month(register_date) = 2  and userrole_id=1;";
                 ...
                 while(rs.next())
                 {
                        ...
                        %>
									...
									<tr class="row100 body">
										...
										<td class="cell100 column3"><%= rs.getString("contactperson_name")%></td>
