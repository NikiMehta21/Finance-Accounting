<%-- 
    Document   : financerdaily
    Created on : 10 Mar, 2019, 9:23:33 AM
    Author     : ASUS
--%>
...
<!--===============================================================================================-->
    	...
    	<div class="limiter">
            <div class="knockout">Today Registered</div>
			...
			<div class="wrap-table100">
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/growfunds_db", "root", "");
                 Statement st = con.createStatement();
                         ...
                         sql="select * from user_master where register_date=curdate() and userrole_id=1";
